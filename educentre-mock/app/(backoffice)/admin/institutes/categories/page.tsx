...
import { instituteCategories, Category } from '@/lib/mock-data/categories';
import { Folder, Plus, Pencil, Trash2 } from 'lucide-react';

export default function InstituteCategoriesPage() {
  const [categories, setCategories] = useState(instituteCategories);
  ...
  const totalInstitutesInCategories = categories.reduce((sum, cat) => sum + cat.count, 0);

  return (
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Institute Categories</h1>
          <p className="text-muted-foreground">
            Organize institutes into categories for better management
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Active institute categories</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{totalInstitutesInCategories}</div>
            <p className="text-xs text-muted-foreground">Institutes in categories</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage institute categories</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new category to organize institutes
            </DialogDescription>
          </DialogHeader>
